...
{/*               end of our story */}
              <Card>
                <CardContent className="p-6">
                  ...
                  <ol className="space-y-4 list-decimal list-inside text-muted-foreground">
                    <li>Sign Up on Squaredance: We've partnered with Squaredance to make joining our affiliate program seamless. Click the link below to create your free Squaredance account.</li>
                    <li>Apply to the Recipee Partner Program: Once you've signed up, you can easily apply to the Recipee Partner Program within your Squaredance dashboard.</li>
                    <li>Get Your Unique Link: After your application is approved, you'll receive your unique affiliate link.</li>
                    <li>Start Sharing & Earning: Promote Recipee to your audience and watch your commissions grow. Get paid weekly every Friday!</li>                 
                  </ol>
